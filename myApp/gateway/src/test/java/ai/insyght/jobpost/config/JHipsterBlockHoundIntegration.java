...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ai.insyght.jobpost.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ai.insyght.jobpost.security.DomainUserDetailsService", "createSpringSecurityUser");
